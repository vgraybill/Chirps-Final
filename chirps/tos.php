...
<main>
        <div class='wrapper'>
                <div class="terms">
                        <div class="flex">
                                <h2>Terms of Use</h2>
                                <h3>Last updated March 1, 2022</h3>
                        </div>
                        <div id="1">
                                <h3>Agreement to Terms</h3>
                                <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Ginny Graybill Designs ("Company," “we," “us," or “our”), concerning your access to and use of the http://ginnygraybill.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
                                ...
                                <a href="#" id="2"><p>Back to Top</p></a>
                        </div>
                        <div >
                                <h3>Disclaimer</h3>
                                <p>I'm a student and this is a class project website. It's not intended for use outside of testing purposes and getting a grade. Again, this is a project for my very first PHP/SQL class, and I'm only JUST LEARNING about data security and user bases. DO NOT give out any vital information here. By agreeing to these terms, I will not liable for what happens to any data you put into this website's database.</p>
                        ...
                        <div>
                                ...
                                <a href="#"  id="10"><p>Back to Top</p></a>
                        </div>
                        <div>
                                ...
                                <a href="#" id="11"><p>Back to Top</p></a>
                        </div>      
                        <div>
                                ...
                                <a href="#" id="12"><p>Back to Top</p></a>
                        </div>
                        <div>
                                <h3>Copyright Infingements</h3>
                                ...
                                <a href="#" id="13"><p>Back to Top</p></a>
                        </div>
                        <div>
                                ...
                                <a href="#" id="14"><p>Back to Top</p></a>
                        </div>
                        <div>
                                ...
                                <a href="#" id="15"><p>Back to Top</p></a>
                        </div>
                        <div>
                                <h3>Governing Law</h3>
                                ...
                                <a href="#"  id="16"><p>Back to Top</p></a>
                        </div>
                        <div>
                                ...
                                <p>If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved through binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association ("AAA") and, where appropriate, the AAA’s Supplementary Procedures for Consumer Related Disputes ("AAA Consumer Rules"), both of which are available at the AAA website: www.adr.org. Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in San Diego, California. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.</p>
                                <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in San Diego, California, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) is excluded from these Terms of Use.</p>
                                ...
                                <a href="#" id="17"><p>Back to Top</p></a>
</p>
                        </div>
                        <div>
                                <h3>Corrections</h3>
                                ...
                                <a href="#" id="18"><p>Back to Top</p></a>
                        </div>
                        <div>
                                ...
                                <a href="#"  id="19"><p>Back to Top</p></a>
                        </div>
                        <div>
                        ...
                        <div>
                                ...
                                <br>Ginny Graybill Designs
                                <br>United States
                                <br>Phone: (207)837-7159
                                <br>ginnygraybilldesigns@gmail.com</p>
                ...
                <aside class="tos-aside">
                        ...
                        <ul>
                                <li><a href="tos.php">Agreement to Terms</a></li>
                                <li><a href="tos.php#2">Disclaimer</a></li>
                                <li><a href="tos.php#3">Intellectual Property Rights</a></li>
                                <li><a href="tos.php#4">User Representations</a></li>
                                <li><a href="tos.php#5">User Registration</a></li>
                                <li><a href="tos.php#6">Prohibited Activities</a></li>
                                <li><a href="tos.php#7">User Generated Contributions</a></li>
                                <li><a href="tos.php#8">Contribution Licence</a></li>
                                <li><a href="tos.php#9">Submissions</a></li>
                                <li><a href="tos.php#10">Site Management</a></li>
                                <li><a href="tos.php#11">Privacy Policy</a></li>
                                <li><a href="tos.php#12">Copyright Infingements</a></li>
                                <li><a href="tos.php#13">Terms and Termination</a></li>
                                <li><a href="tos.php#14">Modifications and Interuptions</a></li>
                                <li><a href="tos.php#15">Governing Law</a></li>
                                <li><a href="tos.php#16">Dispute Resolution</a></li>
                                <li><a href="tos.php#17">Corrections</a></li>
                                <li><a href="tos.php#18">Limitations of Liability</a>
                                <li><a href="tos.php#19">Indemnification</a></li>
                                <li><a href="tos.php#20">User Data</a></li>
                                <li><a href="tos.php#21">Electronic Communications, Transactions and Signatures</a></li>
                                <li><a href="tos.php#22">California Users and Residents</a></li>
                                <li><a href="tos.php#23">Contact Us</a></li>
